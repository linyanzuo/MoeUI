...
public extension Designator {
    static func makeView(toView: UIView? = nil,
                         _ closure: DesignClosure?) -> MoeView
    { return addView(MoeView(frame: .zero), to: toView, closure) as! MoeView }
    
    static func makeLabel(toView: UIView? = nil,
                          _ closure: DesignClosure?) -> MoeLabel
    { return addView(MoeLabel(frame: .zero), to: toView, closure) as! MoeLabel }
    
    static func makeButton(toView: UIView? = nil,
                           _ closure: DesignClosure?) -> MoeButton
    { return addView(MoeButton(type: .custom), to: toView, closure) as! MoeButton }
    
    static func makeImageView(toView: UIView? = nil,
                              _ closure: DesignClosure?) -> MoeImageView
    { return addView(MoeImageView(frame: .zero), to: toView, closure) as! MoeImageView }
    
    static func addView(_ view: ValuationViewProtocol,
                        to superView: UIView?,
                        _ closure: DesignClosure?)
