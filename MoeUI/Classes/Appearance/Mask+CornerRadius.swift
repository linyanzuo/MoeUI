...
extension CALayer {
    ...
    struct RuntimeKey {
        static let cornerRadiusMaskLayer = runtimeKey(for: "cornerRadiusMaskLayer")!
        static let maskImage = runtimeKey(for: "maskImage")!
        static let maskImageAttribute = runtimeKey(for: "maskImageAttribute")!
    }
